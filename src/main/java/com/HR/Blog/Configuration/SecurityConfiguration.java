...
public class SecurityConfiguration {
    ...
    public static final String[] PUBLIC_URLS = {"/api/auth/**","/api/users/add","/api/categories/create", "/api/users/{followerId}/follow/{userId}" , "/api/users/{followerId}/unfollow/{userId}" , "/api/users/{userId}/following", "/api/users/{userId}/followers" ,
